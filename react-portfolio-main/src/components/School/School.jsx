...
export const School = () => {
  return (
    <section className={styles.container} id="school">
      <h2 className={styles.title} style={{ marginBottom: '20px' }}>School & Department</h2>
      <div style={{ display: 'flex', flexWrap: 'wrap', justifyContent: 'space-around', gap: '20px' }}>
        <div style={{ display: 'flex', flexDirection: 'column', alignItems: 'center', maxWidth: '45%' }}>
          ...
          />
          <p className={styles.imageDescription} style={{ marginTop: '10px', marginBottom: '10px' }}>Saint Columban College</p>
          <p style={{ textAlign: 'center' ,fontSize:'20px'}}>Known to be one of the most leading institutions in Pagadian City, Saint Columban College, in its pursuit of academic excellence and character formation, has taken on the spotlight of producing globally-competitive graduates since its founding. As an institution since 1957, SCC offers the complete educational package from kindergarten to graduate school. Withstanding every challenge and adversities for 64 years and counting; SCC became not just an institution but a home to many SCCians.</p>
        </div>
        <div style={{ display: 'flex', flexDirection: 'column', alignItems: 'center', maxWidth: '45%', marginTop: '-20px' }}>
          <img
